...
The following plots are generated using instacart data. The original data is quite extensive, so the dataset has been randomly sampled and filtered to ensure a reasonable product. 
```{r}
library(tidyverse)
library(viridis)
